                            ...
                            {{-- <div style="text-align: center" class="p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="btn-group w-100" role="group">
                                        <a href="{{ route('login') }}" class="btn btn-default btn-sidebar btn-color" style="background: #3a3b3c">Login</a>
                                        <a href="{{ route('register') }}" class="btn btn-default btn-sidebar btn-color">SignUp</a>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input style="outline: 1px solid #fff; margin-right: 8px" class="form-check-input include-check-box" type="checkbox" name="remember" id="remember"
